...
import { Discord } from "../components/icons/Discord"; // adjust path if needed
...
const WORDS = ["Programmer", "An Engineer", "Tech Enthusiast"];
const TECH_STACK = [
  "React",
  "Javascript",
  "Node.js",
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/SaurabhOG" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/saurabh-gaikwad18/" },
  { icon: Discord, link: "/" },
  { icon: Instagram, link: "/" },
];
