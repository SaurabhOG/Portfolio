...
const techStacks = [
  ...
  { icon: "expressjs.png", language: "Express JS" },
  { icon: "nodejs.svg", language: "Node JS" },
  { icon: "bootstrap.svg", language: "Bootstrap" },
  { icon: "cpp.png", language: "C++" },
...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      // Fetch data from Supabase in parallel: projects and certificates tables
  ...
  // The rest of the component (return statement) is unchanged
  return (
    <div
