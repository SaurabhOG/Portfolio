        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I’m a skilled software developer with hands-on experience in{" "}
              <span className="bg-indigo-600/10 text-indigo-400 px-2 py-0.5 rounded-md font-medium">
                JavaScript
              </span>{" "}
              and strong expertise in frameworks like{" "}
              <span className="bg-indigo-600/10 text-indigo-400 px-2 py-0.5 rounded-md font-medium">
                React
              </span>
              ,{" "}
              ...
              . I’m a fast learner who works closely with clients to build
              efficient, scalable, and user-friendly solutions that address
              real-world problems. Let’s collaborate to bring your ideas to
              life!
            </p>
